...
<b>⚙️ Настройка интервалов:</b>
• /interval 30 - для ВСЕХ источников
• /interval 1 30 - для источника #1 (30 минут)
⚠️ Минимальный интервал: 5 минут

<b>🔍 Ручная проверка:</b>
• /check - проверить все источники
• /check diamond - проверить конкретный
⚠️ Ручная проверка НЕ влияет на расписание автопроверок!

<b>📊 Режим отображения:</b>
• /icons - переключить между иконками и текстом
• В группах настройка синхронизируется для всех
...
Проверить источник Diamond:
/check diamond

Примечание: Ручная /check не сбивает расписание автопроверок!"""
